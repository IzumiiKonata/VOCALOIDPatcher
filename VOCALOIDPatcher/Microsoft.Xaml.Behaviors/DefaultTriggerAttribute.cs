...
/// <summary>
///     Provides design tools information about what <see cref="TriggerBase" /> to instantiate for a given action or
///     command.
/// </summary>
[CLSCompliant(false)]
...
public sealed class DefaultTriggerAttribute : Attribute
{
    ...
    /// <remarks>
    ///     This constructor is useful if the specifed <see cref="TriggerBase" /> has a single argument. The
