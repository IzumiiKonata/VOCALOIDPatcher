...
public sealed class BehaviorCollection : AttachableCollection<Behavior>
{
    ...
    {
        foreach (var behavior in this) behavior.Attach(AssociatedObject);
    }
    ...
    {
        foreach (var behavior in this) behavior.Detach();
    }
    ...
    {
        if (AssociatedObject != null) item.Attach(AssociatedObject);
    }
