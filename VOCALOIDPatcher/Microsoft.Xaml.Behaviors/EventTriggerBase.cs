...
public abstract class EventTriggerBase : TriggerBase
{
	...
	public object Source
	{
		get
		{
			...
			else if (IsSourceNameSet)
			{
				...
				{
					throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, ExceptionStringTable.RetargetedTypeConstraintViolatedExceptionMessage, GetType().Name, obj.GetType(), SourceTypeConstraint, "Source"));
				}
			}
			return obj;
		}
	...
	private static void OnSourceObjectChanged(DependencyObject obj, DependencyPropertyChangedEventArgs args)
	{
		...
		object obj2 = eventTriggerBase.SourceNameResolver.Object;
		if (args.NewValue == null)
		{
			eventTriggerBase.OnSourceChanged(args.OldValue, obj2);
			return;
		}
		if (args.OldValue == null && obj2 != null)
		{
			eventTriggerBase.UnregisterEvent(obj2, eventTriggerBase.GetEventName());
		}
